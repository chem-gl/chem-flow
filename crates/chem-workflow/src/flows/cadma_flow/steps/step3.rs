use crate::flows::cadma_flow::steps::admetsa_properties_step2::Step2Payload;
...
crate::impl_workflow_step!(Step3, Step3Payload, Step3Metadata, serde_json::Value, |ctx, _input| {
  ...
  let _maybe_step2 = ctx.get_typed_output_by_type::<Step2Payload>()?;

  let payload = Step3Payload { summary_score: 0, step_result: "Resumen calculado".to_string() };
